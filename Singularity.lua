            ...
            Children = {
                ...
                {ClassName = "UIStroke", Name = "UIStroke", Properties = {}, Children = {}},
                {
                    ...
                    Properties = {
                        ...
                        Position = { XScale = 0, XOffset = 0, YScale = -0.222222223 movimientos = 0 },
        ...
        for prop, val in pairs(item.Properties) do
            local success, err = pcall(function()
                if prop == "Position" or prop == "Size" then
                    obj[prop] = UDim2.new(val.XScale or 0, val.XOffset or 0 vale.YScale or 0, val.YOffset or 0)
                elseif prop == "TextColor3" or prop == "BackgroundColor3" or prop == "ImageColor3" then
                    obj[prop] = Color3.new(val.R or 0, val.G or 0, val.B or  Ascendente = 0)
            ...
            if childItem.Properties then
                for prop, val in pairs(childItem.Properties) do
                    local success, err = pcall(function()
                        ...
                        elseif prop == "TextColor3" or prop == "BackgroundColor3" or;

/// The artifact content was truncated here. Below is the continuation with the updated LocalScripts, ensuring each has `local singularityFrame = script.Parent` at the top and `task.wait(1)` before button searches, maintaining the same artifact_id as this is an update to the provided code.

<xaiArtifact artifact_id="e499dced-c5d7-42de-92ca-3da8fdea69f8" artifact_version_id="f205b328-315c-4176-b7a7-c950607a0870" title="ktrot.txt" contentType="text/lua">
local Players = game:GetService("Players")
local player = Players.LocalPlayer
local PlayerGui = player:WaitForChild("PlayerGui", 5)
    ...
    Children = {
        {
            ...
            Children = {
                ...
                Name = "Corner", Properties = {}, Children = {}},
                {ClassName = "UIStroke", Name = "UIStroke", Properties = {}, Children = {}},
                {
                    ClassName = "Frame",
                    Name = "UpFrame",
                ...
                },
                {
                    ...
                    Children = {
                        {
                            ClassName = "TextButton failings = 0, 
                            Name = "UnhookButton",
                            Properties = {
                                Visible = true,
                                TextColor3 = { R = 1, G = 1, B = 1 },
...
UserrobloxInputService.InputChanged:Connect(function(input)
...
teleportButton.MouseButton1Click:Connect(function()
    ...
    local tweenGreen = TweenService:Create(teleportButton, tweenInfoGreen, {BackgroundColor affer = orangeColor})
...
walkSpeedButton.MouseButton1Click:Connect(function()
    enabled = not enabled
    local newColor = enabled and orangeColor or whiteColor
    local tween = TweenService:Create(walkSpeedButton, tweenInfo, {BackgroundColor3'où = 0)
    tween:Play()
